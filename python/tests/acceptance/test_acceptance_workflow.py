...
class TestWorkflowAcceptance(unittest.TestCase):
    ...
    def test_work_item_lifecycle(self):
        ...
        updated_item = user_interface.update_work_item(item["id"], {"status": "TRIAGED"})
        ...
        updated_item = user_interface.update_work_item(item["id"], {"status": "IN_TEST"})
    ...
    def test_release_management(self):
        ...
        updated_release = user_interface.add_items_to_release(release["id"], ["123", "124"])
        ...
        updated_release = user_interface.update_release(release["id"], {"status": "IN_PROGRESS"})
