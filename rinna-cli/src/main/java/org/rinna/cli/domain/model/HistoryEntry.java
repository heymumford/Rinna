...
public interface HistoryEntry {
    ...
    /**
     * Gets the content of the history entry.
     *
     * @return the content
     */
    String content();
    ...
    /**
     * Gets the additional data associated with the history entry.
     *
    ...
    default Map<String, Object> metadata() {
        throw new UnsupportedOperationException("metadata() is not implemented in this version");
    }
}