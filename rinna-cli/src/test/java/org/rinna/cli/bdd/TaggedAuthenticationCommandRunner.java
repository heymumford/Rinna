/*
 * Tagged runner for Authentication command BDD tests
 *
...
/**
 * JUnit 5 tagged runner for authentication command tests.
...
public class TaggedAuthenticationCommandRunner {
