/*
 * BDD test runner for Admin Configuration and Management features
 *
...
/**
 * Test runner for Admin Configuration and Management features.
 * This runner targets workflow configuration, user management, and work item type management.
 */
@Suite
@IncludeEngines("cucumber")
@SelectClasspathResource("features")
@ConfigurationParameter(key = PLUGIN_PROPERTY_NAME, 
        value = "pretty, json:target/cucumber-reports/admin-config-report.json, " +
                "html:target/cucumber-reports/admin-config-report.html")
...
public class AdminConfigurationRunner {
