...
public class RinnaCliTestRunner {
    ...
    public static void main(String[] args) {
        ...
        List<Class<?>> testClasses = Arrays.asList(
                org.rinna.cli.unit.ViewCommandTest.class,
                org.rinna.cli.component.CommandExecutionTest.class,
                org.rinna.cli.integration.CliServiceIntegrationTest.class,
                org.rinna.cli.acceptance.WorkflowAcceptanceTest.class,
                org.rinna.cli.performance.CliPerformanceTest.class
        );
